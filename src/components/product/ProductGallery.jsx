...
export default function ProductGallery({ images, productData }) {
  ...
  return (
    <div className="flex flex-col gap-4">
      {/* Main Image */}
      <div className="relative aspect-[4/3] sm:aspect-square md:aspect-[4/3] lg:aspect-square xl:aspect-[4/3] w-full bg-gray-50 rounded-2xl overflow-hidden flex items-center justify-center border border-border/50">
        {productData.badge && (
        ...
        <button 
          onClick={prevImage}
          className="absolute left-4 top-1/2 -translate-y-1/2 bg-white rounded-full p-2 shadow-card border border-border/50 text-text-muted hover:text-primary transition-colors"
        >
        ...
        <button 
          onClick={nextImage}
          className="absolute right-4 top-1/2 -translate-y-1/2 bg-white rounded-full p-2 shadow-card border border-border/50 text-text-muted hover:text-primary transition-colors"
        >
